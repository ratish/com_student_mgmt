...
<div class="card-deck">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title border-bottom"><i class="fas fa-user fa-lg"></i> Student Management</h3>
    ...
    <div class="card">
        <div class="card-body">
            <h3 class="card-title border-bottom"><i class="fas fa-book fa-lg"></i> Course Management</h3>
